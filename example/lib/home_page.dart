...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _addOutboxItem() async {
    ...
    await objectBox.addToOutbox(
      operation: "POST",
      url: "https://palng-qa-vsl.mariapps.com/ApiGateway/SPS/api/Inventory/stockTransaction",
      // payload: {
      //   "title": "Hello Outbox",
      //   "body": "Testing offline sync",
      //   "userId": DateTime.now().millisecondsSinceEpoch,
      ...
      payload: {
        ...
        "transactionTypeID": 358,
        "frequencyID": null,
        "remarks": "test save outbox",
        "fromLocationID": 299,
        "toLocationID": null,
        "vesselCode": "788",
        "stockReqEntity": [
          {
            ...
            "unitPrice": 0.0,
            "totalNewStockRob": 0,
            "totalRecondStockRob": 1,
            "totalRob": 30,
            "equipmentID": 0,
            "totalQuantity": 0.0,
            "remarks": "test save outbox",
            "previousLocationID": 299,
            "previousROB": 0,
            "uomID": 0,
            "batchNo": null,
            "isIHM": false,
            ...
            "installationRefID": 0,
            "itemTransactionDate": "2025-11-11T12:15:51",
            "stockGrnList": [],
            "stockSerialList": []
          }
        ]
